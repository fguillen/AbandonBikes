...
class BikeTest < ActiveSupport::TestCase
  def test_update_gps_from_orig_address
    ...
    gps           = "gps coordinates"
    bike          = FactoryGirl.create( :bike, :orig_address => orig_address, :gps => nil )
  ...
  def test_update_gps_from_pic
    gps           = "gps coordinates"
    bike          = FactoryGirl.create( :bike, :orig_address => nil, :gps => nil )
  ...
  def test_update_address_from_gps
    gps           = "gps coordinates"
    address       = "final address"
    bike          = FactoryGirl.create( :bike, :orig_address => nil, :gps => gps )
  ...
  def test_update_date_from_image
    bike = FactoryGirl.create( :bike, pic: File.new( "#{FIXTURES_PATH}/pic_geolocalized.jpg" ) )
  ...
  def test_scope_geolocalized
    bike_1 = FactoryGirl.create( :bike, :gps => 'coordinates' )
    bike_2 = FactoryGirl.create( :bike, :gps => nil )
  ...
  def test_process_pic
    bike = FactoryGirl.create( :bike, :pic => File.new( "#{FIXTURES_PATH}/pic_no_geolocalized.jpg" ) )
